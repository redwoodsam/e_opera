...
class _$LoginParamsImpl extends _LoginParams {
  _$LoginParamsImpl({this.user = '', this.password = ''}) : super._();
  ...
  @override
  String toString() {
    return 'LoginParams(user: $user, password: $password)';
  }
...
abstract class _LoginParams extends LoginParams {
  factory _LoginParams({final String user, final String password}) =
      _$LoginParamsImpl;
